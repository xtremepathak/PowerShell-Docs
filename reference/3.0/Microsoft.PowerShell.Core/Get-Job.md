...
```
PS> Get-Job -Command "*get-process*"
```
...
PS> Start-Job -ScriptBlock {Get-Process} -Name MyJob
...
PS> Start-Job -ScriptBlock {Get-EventLog System}
...
PS> Invoke-Command -ComputerName S1 -ScriptBlock {Get-EventLog System} -AsJob
...
PS> Invoke-Command -ComputerName S2 -ScriptBlock {Start-Job -ScriptBlock {Get-EventLog System}}
