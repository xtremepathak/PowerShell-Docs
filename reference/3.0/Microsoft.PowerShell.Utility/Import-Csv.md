...
```
PS> Get-Process | Export-Csv Processes.csv -UseCulture
PS> $P = Import-Csv Processes.csv -UseCulture
...
```
PS> Start-Job -ScriptBlock { Get-Process } | Export-Csv Jobs.csv
PS> $Header = "State", "MoreData", "StatusMessage", "Location", "Command", "JobState", "Finished", "InstanceId", "Id", "Name", "ChildJobs", "PSBeginTime", "PSEndTime", "PSJobTypeName", "Output", "Error", "Progress", "Verbose", "Debug", "Warning"

# Delete header from file

PS> $A = Get-Content Jobs.csv
PS> $A = $A[0], $A[2..($A.Count - 1)]
PS> $A > Jobs.csv
PS> $J = Import-Csv Jobs.csv -Header $Header
PS> $J
...
InstanceId    : 0971f048-510d-4d53-9b06-c9ee0b91032a
Id            : 2
Name          : Jobs
ChildJobs     : System.Collections.Generic.List`1[System.Management.Automation.Job]
PSBeginTime   : 1/27/2018 6:37:27 PM
PSEndTime     :
...
PS> $A = Import-Csv -Path .\Links.csv -Header LinkID, TopicTitle
PS> $A | Get-Member
...
PS> $A | Where-Object TopicTitle -Like "*alias*"
...
```
PS> Get-Content "\\Server2\c$\Test\Projects.csv"
ProjectID,ProjectName,,Completed
13,Inventory,Redmond,True
440,,FarEast,True
469,Marketing,Europe,False
PS> Import-Csv "\\Server2\c$\Test\Projects.csv"
...
PS> (Import-Csv "\\Server2\c$\Test\Projects.csv").H1
