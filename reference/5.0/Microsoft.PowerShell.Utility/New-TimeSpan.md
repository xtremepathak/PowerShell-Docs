...
When you pipe an object that has a Last*<strong><em>WriteTime property to *</em>New-TimeSpan</strong>, Windows PowerShell uses the value of the **LastWriteTime** property as the value of the *Start* parameter.
